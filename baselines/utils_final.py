"""
Utility functions for baseline experiments - FINAL CLEAN VERSION
All components load from your HuggingFace model (now fixed!)
"""
import sys
import os
import torch
...
def load_model(model_path="kulsoom-abdullah/Qwen2-Audio-7B-Transcription"):
    """Load Qwen2-Audio model - all components from your HF repo"""
...
def process_images(images, messages, processor):
    """Process using native Qwen2-VL API"""
